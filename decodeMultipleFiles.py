...
path_save = '/Volumes/home/datasets/lodopab-ct/ground_truth_test/png/'
...
for i in range(0, img_shape_slices-1):
    # img_buf_2d.append(data_buf[i, :, :])
    save_filename = path_save + "%d.png" % i
    plt.imsave(save_filename, data_buf[i, :, :], cmap='gray')


hdf5.close()
# show_images(img_buf_2d, cols=10)
